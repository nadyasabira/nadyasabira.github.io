				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
                            ...
                            <div class="container">
							<div class="card-body"> -->
							<form action="<?= base_url('konsumen/proses_tambah') ?>"class="formkonsumen" id="form-tambah" method="POST">
								<div class="mb-3">
                           			 <label class="form-label">ID Konsumen</label>
										<input type="text" name="id_konsumen" placeholder="Masukkan ID Konsumen" value="<?php echo $id_konsumen;?>"autocomplete="off"  class="form-control" readonly>
								  </div>
								<div class="form-group mb-3">
                           			 <label class="form-label">Nama Konsumen</label>
										<input type="text" name="nama_konsumen" placeholder="Masukkan Nama Konsumen" autocomplete="off"  class="form-control" required>
								  </div>								
