<h2 class="page-title">
    ...
    <div class="row mt-3">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
           <a class="btn btn-success mb-3" href="<?= base_url('form_permintaan_bp/input_form') ?>">
           <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
  Tambah Data
</a>
           <!-- <a href="<?= base_url('lap_permintaan_bp') ?>" class="btn btn-danger mb-3" role="button" aria-pressed="true">Laporan Permintaan</a> -->
          </div>
          <div class="card-body">
            <table class="table table-striped table-bordered" id="tabelakun">
              ...
              <tbody>
            		...
            		?>
          			<td>
          				<button onclick="location.href = '<?php echo site_url('form_permintaan_bp/view_data_detail2/'.$cacah['id_permintaan_bp']) ?>'" type="button" class="btn btn-info btn-sm">
