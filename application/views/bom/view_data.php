<h2 class="page-title">Bill of Material</h2>   
  <div class="row mt-3">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <a class="btn btn-success mb-3" href="<?= base_url('bom/input_form') ?>">
        ...
        <div class="card-body">
          <table class="table table-striped table-bordered" id="tabelakun">
            ...
            <tbody>
              ...
              ?>
         			<td>
         				<button onclick="location.href = '<?php echo site_url('bom/view_data_detail/'.$cacah['id_bom']) ?>'" type="button" class="btn btn-info btn-sm">
         				  <span class="glyphicon glyphicon-menu-hamburger"></span> Detail
              </td>
              <td>
              <button onclick="location.href = '<?php echo site_url('bom/edit_form/'.$cacah['id_bom']. '/' . $cacah['id_menu']) ?>'" type="button" class="btn btn-success btn-sm">
