...
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <a class="btn btn-success mb-3" href="<?= base_url('bahanpenolong/input_form') ?>">
            ...
            <?php
              ...
              foreach($isi_data as $cacah):
                echo "<tr>";
                  ...
                  echo "<td>";
            ?>
            <button onclick="location.href = '<?php echo site_url('bahanpenolong/edit_form/'.$cacah['id_bp']) ?>';" type="button" class="btn btn-success btn-sm">
