				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
                            ...
                            <div class="container">
							<div class="card-body"> -->
							<form action="<?= base_url('menu1/proses_ubah') ?>"class="formmenu" id="form-tambah" method="POST">
								<div class="mb-3">
                           			 <label class="form-label">ID Menu</label>
										<input type="text" name="id_menu" placeholder="Masukkan Kode Barang" value="<?php echo $menu['id_menu'];?>"autocomplete="off"  class="form-control" readonly>
								  </div>
