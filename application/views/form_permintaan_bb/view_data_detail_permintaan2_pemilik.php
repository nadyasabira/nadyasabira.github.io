...
<!-- /.content-header -->
	<div class="d-flex flex-column">
		<div class="container-fluid">
			<div class="clearfix">
				<h2 class="page-title">Data Permintaan Bahan Baku</h2><hr>
			</div>
			<?php 
    			//cacah data dari tabel detail pembelian dengan id sesuai dengan inputan user
				foreach($isi_data as $cacah):
					$id_permintaan_bb = $cacah['id_permintaan_bb'];
					$tanggal = $cacah['tanggal'];
				endforeach;
			?>
			<div class="card shadow">
				<div class="card-header">
					<strong>Detail Permintaan - <?= $cacah['id_permintaan_bb'] ?></strong>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12">
    						...
    						<div align="center">
				<a href="<?= base_url('form_permintaan_bb/view_data_pemilik') ?>" class="btn btn-info">Kembali</a>
			</div><br>
						</div>
					</div>		
				</div>
