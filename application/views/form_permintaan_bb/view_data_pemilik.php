          ...
          <div class="card-body">
            <table class="table table-striped table-bordered" id="tabelakun">
              ...
              <tbody>
                ...
                ?>
                <td>
                  <button onclick="location.href = '<?php echo site_url('form_permintaan_bb/view_data_detail2_pemilik/'.$cacah['id_permintaan_bb']) ?>'" type="button" class="btn btn-info btn-sm">
