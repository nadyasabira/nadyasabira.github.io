      ...
      Tambah Data
                  ...
                  <?php
                    ...
                    foreach($all_harga as $cacah):
                      echo "<tr>";
                        ...
                        echo "<td>";
                  ?>
                    <button onclick="location.href = '<?php echo site_url('hargamenu/edit_form/'.$cacah['kode_harga']) ?>';" type="button" class="btn btn-success btn-sm">
        ...
        $(function(){
            $("#tambah").click(function(){
                ...
                $("#loadforminputmenu").load("<?php echo base_url(); ?>hargamenu/tambah");
            });
