				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
                            ...
                            <div class="container">
                            	<div class="card-body"> -->
								<form action="<?= base_url('hargamenu/proses_tambah') ?>"class="formharga" id="form-tambah" method="POST">
                            			...
                            			<div class="form-group mb-3">
                            				...
                            				<input type="text" name="satuan" id="satuan" placeholder="Masukkan Satuan" autocomplete="off"  class="form-control" required>
                            			</div>                            			
                            			<div class="form-group mb-3">
