<h2 class="page-title">Data Biaya Angkut Pembelian</h2>   
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <a href="<?php echo base_url();?>beban_angkut/input_beban" class="btn btn-success mb-3">
        ...
        <table class="table table-striped table-bordered" id="tabelmenu">
          <thead>
            <tr>
              ...
              <th class="text-center">No Faktur Pembelian</th>
