<div class="content-wrapper">
	<div class="d-flex flex-column">
		<div class="container-fluid">
			<div class="clearfix">
				<h2 class="page-title">Data Pembelian Bahan Baku</h2><hr>
			</div>
			<?php 
			...
			<div class="card shadow">
				<div class="card-header"><strong>Detail Pembelian</strong></div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
    					...
    					<div align="center">
								<a href="<?= base_url('pembelian') ?>" class="btn btn-info">Kembali</a>
							</div>
						</div>
					</div>		
				</div>
