<h2 class="page-title">Data Pembelian Bahan Baku</h2>   
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <a class="btn btn-success mb-3" href="<?= base_url('pembelian/input_form') ?>">
      ...
      <div class="card-body">
        <table class="table table-striped table-bordered" id="tabelakun">
          ...
          <tbody>
         		...
         		?>
        		<td>
        			<button onclick="location.href = '<?php echo site_url('pembelian/view_data_detail2/'.$cacah['no_faktur'].'/'.$cacah['id_supplier']) ?>'" type="button" class="btn btn-info btn-sm">
        			  <span class="glyphicon glyphicon-menu-hamburger"></span> Detail
            </td>
            <td>
              <button onclick="location.href = '<?php echo site_url('pembelian/cetak/'.$cacah['no_faktur'].'/'.$cacah['id_supplier']) ?>'" type="button" class="btn btn-success btn-sm">
